 ...
 */ !(function (e) {
  ...
  function (e, t, n) {
    ...
    var _,
      ...
      T = (r.env.ios = /(ipod|iphone|ipad)/.test(I));
    (r.env.safari = /safari/.test(I) && !y && !T),
      g &&
  ...
  function (e, t, n) {
    ...
    t.rawDataImported = function (e) {
      return { type: c, payload: (0, i.default)({}, C(e)) };
    };
      ...
      var l = (function (e, t, n) {
          ...
          return function r(u, c) {
            ...
            return (
              ...
              (s.open = function (e) {
                if (
                  ((f = {}),
                  o(e) ? (f = e.call(s, p, d, s, u)) : i(e) && (f = e),
                  i(f))
                )
        ...
        N = function (e) {
          ...
          for (t = 0; t < C.length; t++)
            if ((n = C[t] + r) in R.style) return { dom: n, css: w[t] + e };
        },
        L = (t.support = {
      ...
      var x = (t.frame = (function () {
        ...
        F = l(function (t) {
          ...
          (t.init = function (t) {
            ...
            L.backface &&
              H.hideBackface &&
              K(this.el, L.backface.css, "hidden");
          }),
            g("add", i),
            g("start", o),
            g("wait", function (e) {
            ...
            g("stop", u),
            g("set", function (e) {
              u.call(this, e), p.call(this, e, h, I);
            }),
            g("show", function (e) {
        ...
        j = l(F, function (t) {
          function n(t, n) {
            var r = e.data(t, E) || e.data(t, E, new F.Bare());
        ...
        G = l(function (e) {
          ...
          (e.init = function (e, t, n, r) {
            ...
            n[2] && (o = n[2]),
              ...
              (this.name = o),
              (this.type = n[1]),
              (this.duration = c(t[1], this.duration, i)),
              (this.ease = (function (e, t, n) {
                return void 0 !== t && (n = t), e in f ? e : n;
              })(t[2], this.ease, a)),
              (this.delay = c(t[3], this.delay, u)),
        ...
        k = l(function (t) {
          function n() {
            var e,
              ...
              r,
              i = c.length;
            if (i) for (x(n), t = M(), e = i; e--; ) (r = c[e]) && r.render(t);
          }
  ...
  function (e, t, n) {
    ...
    e.exports = function (e, t, n, c, s, l) {
      ...
      for (l.set(e, t), l.set(t, e); ++E < d; ) {
        var I = e[E],
          g = t[E];
        if (c) var y = f ? c(g, I, E, t, e, l) : c(I, g, E, e, t, l);
        if (void 0 !== y) {
          if (y) continue;
          h = !1;
          break;
        ...
        if (_) {
          if (
            !i(t, function (e, t) {
              if (!o(_, t) && (I === e || s(I, e, n, c, l))) return _.push(t);
            })
          ) {
            h = !1;
            break;
          }
        } else if (I !== g && !s(I, g, n, c, l)) {
          h = !1;
          break;
        }
      }
  ...
  function (e, t) {
    ...
    e.exports = function (e, t, s, l) {
      ...
      if (e !== t || s !== l) for (var v = 0; v < a; ++v) f[v] = d(v * u, e, s);
      function E(t) {
        for (var c = 0, l = 1, v = a - 1; l !== v && f[l] <= t; ++l) c += u;
        var E = c + ((t - f[--l]) / (f[l + 1] - f[l])) * u,
          h = p(E, e, s);
        return h >= r
          ? (function (e, t, r, i) {
              for (var o = 0; o < n; ++o) {
  ...
  function (e, t, n) {
    ...
    var a = o(n(12)),
      ...
      S = c.SCROLL_OUT_OF_VIEW,
      R = c.SCROLLING_IN_VIEW,
      C = c.ECOMMERCE_CART_OPEN,
      w = c.ECOMMERCE_CART_CLOSE,
      N = c.PAGE_START,
      L = c.PAGE_FINISH,
      D = c.PAGE_SCROLL_UP,
      P = c.PAGE_SCROLL_DOWN,
      x = c.PAGE_SCROLL,
      M = { id: null, label: "", description: "", continuous: !1, isPage: !1 },
      F =
        ((r = {}),
        (0, i.default)(
          r,
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      (t.stopActionGroup = he),
      (t.startActionGroup = _e);
    var a = o(n(12)),
      u = o(n(215)),
      c = o(n(63)),
      s = o(n(25)),
      ...
      C = O.W_MOD_IX,
      w = g.IX2VanillaUtils,
      N = w.getAffectedElements,
      L = w.getElementId,
      D = w.getDestinationValues,
      P = w.observeStore,
      x = w.getInstanceId,
      M = w.renderHTMLElement,
      F = w.clearAllStyles,
      j = w.getMaxDurationItemIndex,
      G = w.getComputedStyle,
      V = w.getInstanceOrigin,
      X = w.reduceListToGroup,
      U = w.shouldNamespaceEventParameter,
      k = w.getNamespacedParameterId,
      B = w.shouldAllowMediaQuery,
      W = w.cleanupHTMLElement,
      H = w.stringifyTarget,
      K = w.mediaQueriesEqual,
    ...
    function ee(e, t) {
      var n = e.rawData,
        r = function () {
          ae({ store: t, rawData: n, allowEvents: !0 }), te();
        };
    ...
    function ne(e) {
      return e && (0, E.default)(e, "_EFFECT");
    }
    function re(e, t) {
      ...
      if (r && i && f && u) {
        ...
        d && (f = X({ actionList: d, actionItemId: i, rawData: f }));
      }
      if (
        (ae({ store: t, rawData: f, allowEvents: a, testManual: c }),
        (r && n === I.ActionTypeConsts.GENERAL_START_ACTION) || ne(n))
      ) {
        he({ store: t, actionListId: r }),
          ve({ store: t, actionListId: r, eventId: o });
        var p = _e({
          store: t,
          eventId: o,
          actionListId: r,
    ...
    function ie(e, t) {
      ...
      n ? he({ store: t, actionListId: n }) : Ee({ store: t }), ue(t);
    }
    function oe(e, t) {
      ue(t), F({ store: t, elementApi: T });
    }
    function ae(e) {
      var t,
        n = e.store,
      ...
      i && n.dispatch((0, y.rawDataImported)(i)),
        u.active ||
          ...
          o &&
                        ...
                        !(function (e) {
                          if (Z) {
                            ...
                            for (var r in e) {
                              ...
                              t[u] ||
                                (o !== I.EventTypeConsts.MOUSE_CLICK &&
                                  o !== I.EventTypeConsts.MOUSE_SECOND_CLICK) ||
                                ((t[u] = !0),
                                (n +=
                                  u +
                        ...
                        if ((0, l.default)(d)) {
                          (0, v.default)(d, function (e, t) {
                            ...
                            (a.actionTypeId ===
                              ...
                              ne(a.actionTypeId)) &&
                              ve({ store: n, actionListId: v, eventId: l });
                          });
                          var p = function (e) {
                              var t = n.getState(),
                                r = t.ixSession;
            ...
            -1 === (t = document.documentElement).className.indexOf(C) &&
              (t.className += " ".concat(C)),
          ...
          (function (e, t) {
            !(function n(r) {
              var i = e.getState(),
                ...
                a = i.ixParameters;
              o.active &&
                (e.dispatch((0, y.animationFrameChanged)(r, a)),
                t
                  ? (function (e, t) {
                      var n = P({
                        store: e,
    ...
    function ue(e) {
      ...
      t.active &&
        (t.eventListeners.forEach(ce), e.dispatch((0, y.sessionStopped)()));
    }
    function ce(e) {
      var t = e.target,
        n = e.listenerParams;
    ...
    function le(e) {
      ...
      if (i !== n.viewportWidth) {
        ...
        e.dispatch((0, y.viewportWidthChanged)({ width: i, mediaQueries: o }));
      }
    }
    var fe = function (e, t) {
    ...
    function ve(e) {
      ...
      if (l && l.useFirstGroupAsInitialState) {
        ...
        f.forEach(function (e) {
          var i = e.config,
            o = e.actionTypeId,
            a = N({ config: i, event: c, elementApi: T }),
            u = z(o);
          a.forEach(function (i) {
            var a = u ? Q(o)(i, e) : null;
            Ie({
              destination: D({ element: i, actionItem: e, elementApi: T }, a),
              immediate: !0,
              store: t,
              element: i,
              eventId: r,
    ...
    function he(e) {
      var t = e.store,
        ...
        u = a.ixInstances,
        c =
          a.ixSession.hasBoundaryNodes && r ? T.getClosestElement(r, A) : null;
      (0, v.default)(u, function (e) {
        ...
        if (e.actionListId === o && e.eventId === n && a) {
          if (c && r && !T.elementContains(c, e.element)) return;
          ge(e, t),
            e.verbose &&
              t.dispatch(
                (0, y.actionListPlaybackChanged)({
    ...
    function _e(e) {
      ...
      u >= I.length && (0, s.default)(v, "config.loop") && (u = 0),
        0 === u && g && u++;
      var y =
          (0 === u || (1 === u && g)) && ne(v.action && v.action.actionTypeId)
            ? v.config.delay
            : void 0,
        m = (0, s.default)(I, [u, "actionItems"], []);
      if (!m.length) return !1;
      if (!B(h, p.mediaQueryKey)) return !1;
      var O = p.hasBoundaryNodes && r ? T.getClosestElement(r, A) : null,
        b = j(m),
        S = !1;
      return (
        m.forEach(function (e, a) {
          ...
          if (p) {
            ...
            N({
              ...
              S = !0;
              var h = b === a && 0 === p,
                _ = G({ element: s, actionItem: e }),
                I = D({ element: s, actionItem: e, elementApi: T }, v);
              Ie({
                store: t,
                element: s,
                actionItem: e,
    ...
    function Ie(e) {
      ...
      t.dispatch(
        (0, y.instanceAdded)(
          (0, a.default)(
            { instanceId: f, elementId: E, origin: I, refType: _ },
            r
          )
        )
      ),
        ...
        s
          ...
          : (P({
            ...
            i && t.dispatch((0, y.instanceStarted)(f, v.tick)));
    }
    function ge(e, t) {
      ...
      var n = e.elementId,
        ...
        o = i.ref;
      i.refType === S && W(o, r, T), t.dispatch((0, y.instanceRemoved)(e.id));
    }
    function ye(e, t, n) {
    ...
    function Te(e, t) {
      var n = e.active,
        ...
        m = g.ixData,
        O = g.ixSession,
        b = (m.events[f] || {}).mediaQueries,
        A = void 0 === b ? m.mediaQueryKeys : b;
      if (B(A, O.mediaQueryKey) && (r || n || i)) {
        if (s || (c === R && i)) {
          t.dispatch((0, y.elementStateChanged)(o, u, s, a));
  ...
  function (e, t, n) {
    n(104), n(106), n(55), n(108), n(265), n(266), n(267), (e.exports = n(268));
  },
  function (e, t, n) {
    "use strict";
    var r = n(6);
  ...
  function (e, t, n) {
    ...
    e.exports = function (e, t, n, h, _, I) {
      var g = c(e),
        y = c(t),
        T = g ? p : u(e),
        m = y ? p : u(t),
      ...
      if (A && !O)
        return (
          I || (I = new r()),
          g || l(e) ? i(e, t, n, h, _, I) : o(e, t, T, n, h, _, I)
        );
      if (!(n & f)) {
        var S = O && E.call(e, "__wrapped__"),
          R = b && E.call(t, "__wrapped__");
        if (S || R) {
          var C = S ? e.value() : e,
            w = R ? t.value() : t;
          return I || (I = new r()), _(C, w, n, h, I);
        }
      }
      return !!A && (I || (I = new r()), a(e, t, n, h, _, I));
    };
  },
  function (e, t, n) {
    var r = n(35),
  ...
  function (e, t, n) {
    ...
    e.exports = function (e, t, n, r, m, b, A) {
      switch (n) {
        case T:
  ...
  function (e, t, n) {
    ...
    e.exports = function (e, t, n, a, u, c) {
      ...
      for (var h = s; ++d < f; ) {
        var _ = e[(p = l[d])],
          I = t[p];
        if (a) var g = s ? a(I, _, p, t, e, c) : a(_, I, p, e, t, c);
  ...
  function (e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.createElementState = c),
      (t.mergeActionState = s),
      (t.ixElements = void 0);
    var r = n(15),
      i = n(49),
      o = n(89),
    ...
    function c(e, t, n, o, a) {
      var u =
        n === i.PLAIN_OBJECT
          ...
          : null;
      return (0, r.mergeIn)(e, [o], { id: o, ref: t, refId: u, refType: n });
    }
    ...
    t.ixElements = function () {
      ...
      switch (t.type) {
        ...
        case o.IX2_ELEMENT_STATE_CHANGED:
          var E = t.payload;
          return s(e, E.elementId, E.actionTypeId, E.current, E.actionItem);
        default:
          return e;
      }
    };
  ...
  function (e, t, n) {
    ...
    var u = a(n(12)),
      ...
      E = l.SCROLLING_IN_VIEW_INTERACTION,
      h = l.MOUSE_MOVE_IN_VIEWPORT_INTERACTION,
      _ = l.PAGE_IS_SCROLLING_INTERACTION,
      I = l.PAGE_LOAD_INTERACTION,
      g = l.PAGE_SCROLLED_INTERACTION,
      y = l.NAVBAR_INTERACTION,
      T = l.DROPDOWN_INTERACTION,
      m = l.ECOMMERCE_CART_INTERACTION,
      O = l.TAB_INTERACTION,
      ...
      S =
        ...
        (0, o.default)(
          ...
          (0, u.default)({}, A, {
            ...
            note:
              "Define actions that occur when cursor hovers over or away from element.",
            description:
              "Animate when cursor hovers over or away from element. No touch support.",
          })
        ),
        (0, o.default)(
          r,
          ...
          (0, u.default)({}, A, {
            ...
            note:
              "Define actions that occur when cursor moves over element along X or Y axis.",
            description:
              "Animate while cursor moves over the element along the X or Y axis. No touch support.",
          })
        ),
        (0, o.default)(
          r,
        ...
        (0, o.default)(
          ...
          (0, u.default)({}, A, {
            ...
            headings: ["On scroll"],
            note:
              "Define actions that occur when element scrolls through viewport.",
        ...
        (0, o.default)(
          ...
          (0, u.default)({}, A, {
            ...
            headings: ["On mouse move"],
            note:
              "Define actions that occur while the mouse moves over the viewport along the X or Y axis. No touch support.",
            description:
              "Animate while the mouse moves over the viewport along the X or Y axis. No touch support.",
            isPage: !0,
          })
        ),
        (0, o.default)(
          ...
          (0, u.default)({}, A, {
            ...
            description:
              "Animate elements as entire page scrolls from top to bottom.",
            isPage: !0,
          })
        ),
        (0, o.default)(
          ...
          (0, u.default)({}, A, {
            ...
            note:
              "Define actions that occur when page starts or finishes loading.",
        ...
        (0, o.default)(
          ...
          (0, u.default)({}, A, {
            ...
            note:
              "Select actions to perform when navbar menu opens and closes.",
        ...
        (0, o.default)(
          ...
          (0, u.default)({}, A, {
            ...
            headings: ["Menu opens", "Menu closes"],
            note:
              "Define actions to perform when dropdown menu opens and closes.",
        ...
        (0, o.default)(
          ...
          (0, u.default)({}, A, {
            ...
            note:
              "Define actions to perform when a tab is in view (active) and out of view (inactive).",
        ...
        (0, o.default)(
          ...
          (0, u.default)({}, A, {
            ...
            note:
              "Define actions to perform when slide comes into view and goes out of view.",
            description: "Animate when slide is in view or out of view.",
          })
        ),
        r);
    t.InteractionConsts = S;
    var R =
      ((i = {}),
      (0, o.default)(i, f, [
        c.EventConsts.MOUSE_CLICK,
        c.EventConsts.MOUSE_SECOND_CLICK,
      ]),
      (0, o.default)(i, d, [c.EventConsts.MOUSE_OVER, c.EventConsts.MOUSE_OUT]),
      (0, o.default)(i, v, [
        c.EventConsts.SCROLL_INTO_VIEW,
        c.EventConsts.SCROLL_OUT_OF_VIEW,
      ]),
      (0, o.default)(i, I, [
        c.EventConsts.PAGE_START,
        c.EventConsts.PAGE_FINISH,
      ]),
      (0, o.default)(i, g, [
        c.EventConsts.PAGE_SCROLL_UP,
        c.EventConsts.PAGE_SCROLL_DOWN,
      ]),
      (0, o.default)(i, p, [c.EventConsts.MOUSE_MOVE]),
      (0, o.default)(i, E, [c.EventConsts.SCROLLING_IN_VIEW]),
      (0, o.default)(i, h, [c.EventConsts.MOUSE_MOVE_IN_VIEWPORT]),
      (0, o.default)(i, _, [c.EventConsts.PAGE_SCROLL]),
      (0, o.default)(i, T, [
        c.EventConsts.DROPDOWN_OPEN,
        c.EventConsts.DROPDOWN_CLOSE,
      ]),
      (0, o.default)(i, y, [
        c.EventConsts.NAVBAR_OPEN,
        c.EventConsts.NAVBAR_CLOSE,
      ]),
      (0, o.default)(i, m, [
        c.EventConsts.ECOMMERCE_CART_OPEN,
        c.EventConsts.ECOMMERCE_CART_CLOSE,
      ]),
      (0, o.default)(i, O, [
        c.EventConsts.TAB_ACTIVE,
        c.EventConsts.TAB_INACTIVE,
      ]),
      (0, o.default)(i, b, [
        c.EventConsts.SLIDER_ACTIVE,
        c.EventConsts.SLIDER_INACTIVE,
      ]),
      i);
    t.InteractionToEventsMap = R;
  },
  function (e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }),
  ...
  function (e, t, n) {
    ...
    var o = n(28),
      ...
      E = a.STYLE_BORDER,
      h = a.STYLE_TEXT_COLOR,
      _ = a.PLUGIN_LOTTIE,
      I = a.GENERAL_DISPLAY,
      g = a.GENERAL_START_ACTION,
      y = a.GENERAL_CONTINUOUS_ACTION,
      T =
        ((r = {}),
        (0, i.default)(r, u, { id: u, label: "Move", instant: !1 }),
        (0, i.default)(r, c, { id: c, label: "Scale", instant: !1 }),
        (0, i.default)(r, s, { id: s, label: "Rotate", instant: !1 }),
        (0, i.default)(r, l, { id: l, label: "Skew", instant: !1 }),
        (0, i.default)(r, f, { id: f, label: "Opacity", instant: !1 }),
        (0, i.default)(r, d, { id: d, label: "Size", instant: !1 }),
        (0, i.default)(r, p, { id: p, label: "Filter", instant: !1 }),
        (0, i.default)(r, v, { id: v, label: "Background color", instant: !1 }),
        (0, i.default)(r, E, { id: E, label: "Border color", instant: !1 }),
        (0, i.default)(r, h, { id: h, label: "Text color", instant: !1 }),
        (0, i.default)(r, _, { id: _, label: "Lottie", instant: !1 }),
        (0, i.default)(r, I, { id: I, label: "Hide/Show", instant: !0 }),
        (0, i.default)(r, g, {
          id: g,
  ...
  function (e, t, n) {
    ...
    t.EasingConsts = [
      { header: !0, label: "Default", value: "header-default" },
      { header: !1, label: "Linear (None)", value: "" },
      { header: !1, label: "Ease", value: "ease" },
      { header: !1, label: "Ease In", value: "easeIn" },
      { header: !1, label: "Ease Out", value: "easeOut" },
      { header: !1, label: "Ease In Out", value: "easeInOut" },
      { header: !0, label: "Ease In", value: "header-ease-in" },
      { header: !1, label: "In Quad", value: "inQuad" },
      { header: !1, label: "In Cubic", value: "inCubic" },
      { header: !1, label: "In Quart", value: "inQuart" },
      { header: !1, label: "In Quint", value: "inQuint" },
      { header: !1, label: "In Sine", value: "inSine" },
      { header: !1, label: "In Expo", value: "inExpo" },
      { header: !1, label: "In Circ", value: "inCirc" },
      { header: !1, label: "In Back", value: "inBack" },
      { header: !1, label: "In Elastic", value: "inElastic" },
      { header: !0, label: "Ease Out", value: "header-ease-out" },
      { header: !1, label: "Out Quad", value: "outQuad" },
      { header: !1, label: "Out Cubic", value: "outCubic" },
      { header: !1, label: "Out Quart", value: "outQuart" },
      { header: !1, label: "Out Quint", value: "outQuint" },
      { header: !1, label: "Out Sine", value: "outSine" },
      { header: !1, label: "Out Expo", value: "outExpo" },
      { header: !1, label: "Out Circ", value: "outCirc" },
      { header: !1, label: "Out Bounce", value: "outBounce" },
      { header: !1, label: "Out Back", value: "outBack" },
      { header: !1, label: "Out Elastic", value: "outElastic" },
      { header: !0, label: "Ease In Out", value: "header-ease-in-out" },
      { header: !1, label: "In Out Quad", value: "inOutQuad" },
      { header: !1, label: "In Out Cubic", value: "inOutCubic" },
      { header: !1, label: "In Out Quart", value: "inOutQuart" },
      { header: !1, label: "In Out Quint", value: "inOutQuint" },
      { header: !1, label: "In Out Sine", value: "inOutSine" },
      { header: !1, label: "In Out Expo", value: "inOutExpo" },
      { header: !1, label: "In Out Circ", value: "inOutCirc" },
      { header: !1, label: "In Out Back", value: "inOutBack" },
      { header: !1, label: "In Out Elastic", value: "inOutElastic" },
      { header: !0, label: "Bounce", value: "header-bounce" },
      { header: !1, label: "Bounce", value: "bounce" },
      { header: !1, label: "Bounce Past", value: "bouncePast" },
      { header: !0, label: "Swing", value: "header-swing" },
      { header: !1, label: "Swing From To", value: "swingFromTo" },
      { header: !1, label: "Swing From", value: "swingFrom" },
      { header: !1, label: "Swing To", value: "swingTo" },
    ];
  },
  function (e, t, n) {
    "use strict";
    ...
    var o = n(28),
      ...
      I = a.BLINK_EFFECT,
      g = a.BOUNCE_EFFECT,
      y = a.FLIP_LEFT_TO_RIGHT_EFFECT,
      T = a.FLIP_RIGHT_TO_LEFT_EFFECT,
      m = a.RUBBER_BAND_EFFECT,
      O = a.JELLO_EFFECT,
      b = a.GROW_BIG_EFFECT,
      A = a.SHRINK_BIG_EFFECT,
      S = a.PLUGIN_LOTTIE_EFFECT,
      R = "appear",
      C = "emphasis",
      w = "plugin",
      N =
        ((r = {}),
        (0, i.default)(r, w, [
          { header: !0, label: "Integrations", id: w },
          { header: !1, id: S, label: "Lottie playback" },
        ]),
        (0, i.default)(r, R, [
          { header: !0, label: "Appear & Disappear", id: R },
          { header: !1, id: u, label: "Fade" },
          { header: !1, id: c, label: "Slide" },
          { header: !1, id: v, label: "Flip" },
          { header: !1, id: s, label: "Grow" },
          { header: !1, id: b, label: "Grow big" },
          { header: !1, id: l, label: "Shrink" },
          { header: !1, id: A, label: "Shrink big" },
          { header: !1, id: f, label: "Spin" },
          { header: !1, id: d, label: "Fly" },
          { header: !1, id: _, label: "Drop" },
        ]),
        (0, i.default)(r, C, [
          { header: !0, label: "Emphasis", id: C },
          { header: !1, id: p, label: "Pop" },
          { header: !1, id: E, label: "Jiggle" },
          { header: !1, id: h, label: "Pulse" },
          { header: !1, id: I, label: "Blink" },
          { header: !1, id: g, label: "Bounce" },
          { header: !1, id: y, label: "Flip left to right" },
          { header: !1, id: T, label: "Flip right to left" },
          { header: !1, id: m, label: "Rubber band" },
          { header: !1, id: O, label: "Jello" },
        ]),
        r);
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      (t.getInstanceOrigin = function (e) {
        ...
        switch (o) {
          ...
          case S:
            return { value: (0, l.default)(parseFloat(i(e, g.OPACITY)), 1) };
          case C:
            var u,
              c,
              s = i(e, g.WIDTH),
          ...
          case D:
            return { value: (0, l.default)(i(e, g.DISPLAY), n.display) };
          case P:
            return t[o] || { value: 0 };
          default:
            return;
      ...
      (t.getDestinationValues = function (e) {
        var t = e.element,
          ...
          r = e.elementApi,
          i = n.actionTypeId;
        if ((0, I.isPluginType)(i))
          return (0, I.getPluginDestination)(i)(n.config);
        switch (i) {
          case m:
          case O:
          case b:
          ...
          case C:
            var s = r.getStyle,
              ...
              h = E.widthValue,
              _ = E.heightValue;
            if (!y.IS_BROWSER_ENV) return { widthValue: h, heightValue: _ };
            if (p === g.AUTO) {
              var T = s(t, g.WIDTH);
              l(t, g.WIDTH, ""), (h = f(t, "offsetWidth")), l(t, g.WIDTH, T);
            }
            if (v === g.AUTO) {
              var S = s(t, g.HEIGHT);
              l(t, g.HEIGHT, ""), (_ = f(t, "offsetHeight")), l(t, g.HEIGHT, S);
            }
            return { widthValue: h, heightValue: _ };
          case w:
          case N:
          case L:
            var D = n.config,
              ...
              M = D.bValue,
              F = D.aValue;
            return { rValue: P, gValue: x, bValue: M, aValue: F };
          case R:
          ...
          case g.RENDER_TRANSFORM:
            return (function (e, t, n, r, i) {
              var o = q
                  ...
                  .join(" "),
                a = i.setStyle;
              J(e, y.TRANSFORM_PREFIXED, i),
                a(e, y.TRANSFORM_PREFIXED, o),
                (u = r),
                (c = n),
                (s = u.actionTypeId),
                (l = c.xValue),
                ...
                ((s === m && void 0 !== d) ||
                  (s === O && void 0 !== d) ||
                  (s === b && (void 0 !== l || void 0 !== f))) &&
                  a(e, y.TRANSFORM_STYLE_PREFIXED, g.PRESERVE_3D);
              var u, c, s, l, f, d;
            })(e, t, n, i, a);
          case g.RENDER_STYLE:
                ...
                case L:
                  ...
                  J(e, _, o),
                    a(
                      ...
                      _,
                      m >= 1
                        ? "rgb(".concat(I, ",").concat(y, ",").concat(T, ")")
                        : "rgba("
                            .concat(I, ",")
                            .concat(y, ",")
                            .concat(T, ",")
              ...
              switch (t.actionTypeId) {
                case D:
                  ...
                  return void (i === g.FLEX && y.IS_BROWSER_ENV
                    ? r(e, g.DISPLAY, y.FLEX_PREFIXED)
                    : r(e, g.DISPLAY, i));
              }
            })(e, i, a);
          case g.RENDER_PLUGIN:
            var s = i.actionTypeId;
            if ((0, I.isPluginType)(s)) return (0, I.renderPlugin)(s)(c, t, i);
        }
      }),
      (t.clearAllStyles = function (e) {
        ...
        Object.keys(o).forEach(function (e) {
          var t = o[e],
            ...
            i = r.actionListId,
            a = u[i];
          a && te({ actionList: a, event: t, elementApi: n });
        }),
          Object.keys(u).forEach(function (e) {
            te({ actionList: u[e], elementApi: n });
          });
      }),
      (t.cleanupHTMLElement = function (e, t, n) {
        ...
        if (o === C) {
          var a = t.config;
          a.widthUnit === g.AUTO && r(e, g.WIDTH, ""),
            a.heightUnit === g.AUTO && r(e, g.HEIGHT, "");
        }
        i(e, g.WILL_CHANGE) &&
          re({ effect: ee, actionTypeId: o, elementApi: n })(e);
      }),
      (t.getMaxDurationItemIndex = oe),
          ...
          n.forEach(function (e, t) {
            if (!r || 0 !== t) {
              var n = e.actionItems,
                ...
                l = o.actionTypeId;
              i.id === o.id && (c = u + a);
              var f = K(l) === g.RENDER_GENERAL ? 0 : s.duration;
              u += s.delay + f;
            }
          }),
      ...
      (t.reduceListToGroup = function (e) {
        var t = e.actionList,
          ...
          u = function (e) {
            return (
              a.push((0, v.mergeIn)(e, ["config"], { delay: 0, duration: 0 })),
              e.id === n
            );
          };
        return (
      ...
      (t.shouldNamespaceEventParameter = function (e, t) {
        var n = t.basedOn;
        return (
          (e === h.EventTypeConsts.SCROLLING_IN_VIEW &&
            (n === h.EventBasedOn.ELEMENT || null == n)) ||
          (e === h.EventTypeConsts.MOUSE_MOVE && n === h.EventBasedOn.ELEMENT)
        );
      }),
      (t.getNamespacedParameterId = function (e, t) {
        return e + g.COLON_DELIMITER + t;
      }),
      ...
      (t.mediaQueriesEqual = function (e, t) {
        return (0, E.default)(e && e.sort(), t && t.sort());
      }),
    ...
    var l = s(n(201)),
      ...
      g = n(49),
      y = n(32),
      T = h.ActionTypeConsts,
      m = T.TRANSFORM_MOVE,
      O = T.TRANSFORM_SCALE,
      b = T.TRANSFORM_ROTATE,
      A = T.TRANSFORM_SKEW,
      S = T.STYLE_OPACITY,
      R = T.STYLE_FILTER,
      C = T.STYLE_SIZE,
      w = T.STYLE_BACKGROUND_COLOR,
      N = T.STYLE_BORDER,
      L = T.STYLE_TEXT_COLOR,
      D = T.GENERAL_DISPLAY,
      P = "OBJECT_VALUE",
      x = function (e) {
        return e.trim();
      ...
      M = Object.freeze(
        ((r = {}),
        (0, c.default)(r, w, g.BACKGROUND_COLOR),
        (0, c.default)(r, N, g.BORDER_COLOR),
        (0, c.default)(r, L, g.COLOR),
        r)
      ),
      F = Object.freeze(
        ((i = {}),
    ...
    function k(e) {
      ...
      var R,
        ...
        w,
        N =
          (0, p.default)(n, "action.config.affectedElements", {})[I || m] || {},
        L = Boolean(N.id || N.selector),
        D = n && u(U(n.target));
      if (
        (L
          ? ((R = N.limitAffectedElements), (C = D), (w = u(N)))
          : (C = w = u({ id: I, selector: m, selectorGuids: O })),
        n && A)
      ) {
        var P = r && (w || !0 === A) ? [r] : c(D);
        if (w) {
          if (A === g.PARENT)
            return c(w).filter(function (e) {
      ...
      return null == C || null == w
        ? []
        : y.IS_BROWSER_ENV && i
        ? c(w).filter(function (e) {
            return i.contains(e);
          })
        : R === g.CHILDREN
        ? c(C, w)
    ...
    var B = /px/,
      W = function (e, t) {
        return t.reduce(function (e, t) {
          return null == e[t.type] && (e[t.type] = z[t.type]), e;
        }, e || {});
      };
    var H = function (e, t) {
    ...
    var Y =
        ...
        (0, c.default)(o, A, Object.freeze({ xValue: 0, yValue: 0 })),
        o),
      z = Object.freeze({
        blur: 0,
        "hue-rotate": 0,
      ...
      if (y.IS_BROWSER_ENV) {
        ...
        if (r) {
          var i = n.getStyle,
            ...
            a = i(e, g.WILL_CHANGE);
          if (a) {
            var u = a.split(g.COMMA_DELIMITER).map(x);
            -1 === u.indexOf(r) &&
              o(e, g.WILL_CHANGE, u.concat(r).join(g.COMMA_DELIMITER));
          } else o(e, g.WILL_CHANGE, r);
        }
      }
    }
    function ee(e, t, n) {
    ...
    function te(e) {
      ...
      o &&
        o.forEach(function (e) {
          ne({ actionGroup: e, event: r, elementApi: i });
        }),
        a &&
    ...
    function ne(e) {
      ...
      t.actionItems.forEach(function (e) {
        var t,
          i = e.actionTypeId,
          o = e.config;
        (t = (0, I.isPluginType)(i)
          ? (0, I.clearPlugin)(i)
          : re({ effect: ie, actionTypeId: i, elementApi: r })),
          k({ config: o, event: n, elementApi: r }).forEach(t);
      });
    }
    var re = function (e) {
      var t = e.effect,
      ...
      switch (t.type) {
        ...
        case f:
          var g = t.payload,
            y = g.stateKey,
            T = g.newState;
          return (0, i.setIn)(e, ["eventState", y], T);
        case p:
          var m = t.payload,
            O = m.actionListId,
            b = m.isPlaying;
        ...
        case v:
          ...
          return (0, i.merge)(e, { viewportWidth: S, mediaQueryKey: w });
        case E:
      ...
      T = function (e, t) {
        ...
        for (var A = 0, S = o.length; A < S; A++) {
          ...
          if ((0 === A && (h = w[0]), b >= C)) {
            ...
            var N = o[A + 1],
              L = N && b !== C;
            (_ = L ? N.actionItems[0] : null),
              L && ((g = C / 100), (y = (N.keyframe - C) / 100));
          }
        }
        var D = {};
        if (h && !_)
          ...
          for (
            ...
            var U = a[V],
              k = I(s, U, h.config),
              B = (I(s, U, _.config) - k) * G + k;
            D[U] = B;
          }
        return (0, i.merge)(e, { position: O, current: D });
      },
      m = function (e, t) {
        var n = e,
          r = n.active,
        ...
        if (r && o) {
          ...
          if (s) {
            var A = O - a,
              S = T + m,
              R = p(Math.min(Math.max(0, A / S), 1));
            e = (0, i.set)(e, "verboseTimeElapsed", S * R);
          }
          if (b < 0) return e;
          var C = p(Math.min(Math.max(0, b / T), 1)),
            w = v(g, C, I),
            N = {},
            L = null;
          return (
      ...
      switch (t.type) {
        ...
        case c:
          var n = t.payload,
            ...
            j = g(F),
            G = y(j, F),
            V = Object.keys(A).filter(function (e) {
              return null != A[e];
            }),
            X = d.config.easing;
          return (0, i.set)(e, r, {
        ...
        case s:
          var U = t.payload,
            k = U.instanceId,
            B = U.time;
          return (0, i.mergeIn)(e, [k], { active: !0, complete: !1, start: B });
        case l:
          var W = t.payload.instanceId;
          if (!e[W]) return e;
          for (
            var H = {}, K = Object.keys(e), Y = K.length, z = 0;
            z < Y;
            z++
          ) {
            var Q = K[z];
  ...
  function (e, t, n) {
    ...
    e.exports = function (e, t, n) {
      ...
      function g(t) {
        var n = s,
          r = l;
        return (s = l = void 0), (E = t), (d = e.apply(r, n));
      }
      function y(e) {
        var n = e - v;
        return void 0 === v || n >= t || n < 0 || (_ && e - E >= f);
      }
      function T() {
        var e = i();
        if (y(e)) return m(e);
        p = setTimeout(
          ...
          (function (e) {
            var n = t - (e - v);
            return _ ? c(n, f - (e - E)) : n;
          })(e)
        );
      }
      function m(e) {
        return (p = void 0), I && s ? g(e) : ((s = l = void 0), d);
      }
      function O() {
        var e = i(),
          n = y(e);
        if (((s = arguments), (l = this), (v = e), n)) {
          if (void 0 === p)
            return (function (e) {
              return (E = e), (p = setTimeout(T, t)), h ? g(e) : d;
            })(v);
          if (_) return clearTimeout(p), (p = setTimeout(T, t)), g(v);
        }
      ...
      return (
        ...
        r(n) &&
          ((h = !!n.leading),
          (f = (_ = "maxWait" in n) ? u(o(n.maxWait) || 0, t) : f),
          (I = "trailing" in n ? !!n.trailing : I)),
        (O.cancel = function () {
          void 0 !== p && clearTimeout(p), (E = 0), (s = v = l = p = void 0);
        }),
        (O.flush = function () {
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      (t.getValidDocument = function (e) {
        if (null == e || e === document.documentElement.getAttribute(l))
          return document;
        return null;
      }),
      ...
      (t.getRefType = function (e) {
        if (null != e && "object" == (0, r.default)(e))
          return e instanceof Element ? c : s;
        return null;
      }),
  ...
  function (e, t, n) {
    ...
    var c,
      ...
      P = g.NAVBAR_OPEN,
      x = g.MOUSE_MOVE,
      M = g.PAGE_SCROLL_DOWN,
      F = g.SCROLL_INTO_VIEW,
      j = g.SCROLL_OUT_OF_VIEW,
      G = g.PAGE_SCROLL_UP,
      V = g.SCROLLING_IN_VIEW,
      X = g.PAGE_FINISH,
      U = g.ECOMMERCE_CART_CLOSE,
      k = g.ECOMMERCE_CART_OPEN,
      B = g.PAGE_START,
      W = g.PAGE_SCROLL,
      H = "COMPONENT_ACTIVE",
      K = "COMPONENT_INACTIVE",
      Y = I.IX2EngineConstants.COLON_DELIMITER,
      z = I.IX2VanillaUtils.getNamespacedParameterId,
      Q = function (e) {
        return function (t) {
      ...
      ne = { handler: te(Z, ee) },
      re = (0, f.default)({}, ne, { types: [H, K].join(" ") }),
      ie = [
      ...
      le = function (e) {
        return function (t, n) {
          var r = t.nativeEvent.type,
            i = -1 !== [H, K].indexOf(r) ? r === H : n.isActive,
      ...
      de = function (e) {
        return function (t) {
          ...
          n &&
            ((E = v > n.percentTop),
            (I = (h = n.scrollingDown !== E) ? v : n.anchorTop));
          var g = s === M ? v >= I + _ : v <= I - _,
            y = (0, f.default)({}, n, {
              percentTop: v,
              inBounds: g,
              anchorTop: I,
          ...
          return (n && g && (h || y.inBounds !== n.inBounds) && e(t, y)) || y;
        };
      },
      pe = function (e) {
        return function (t) {
      ...
      _e =
        ...
        (0, o.default)(r, R, ve()),
        (0, o.default)(r, S, Ee()),
        (0, o.default)(r, P, ve(!1)),
        (0, o.default)(r, D, Ee(!1)),
        (0, o.default)(r, N, ve()),
        (0, o.default)(r, L, Ee()),
        (0, o.default)(r, k, {
        ...
        (0, o.default)(r, m, (0, f.default)({}, ne, { types: "mousedown" })),
        ...
        (0, o.default)(r, x, {
          ...
          handler: function (e) {
            ...
            switch (u) {
              ...
              case E.EventBasedOn.PAGE:
                var C = ue(),
                  ...
                  L = C.scrollWidth,
                  D = C.scrollHeight;
                A = O ? Math.min(w + y, L) / L : Math.min(N + m, D) / D;
                break;
            ...
            return (
              ...
              (u !== E.EventBasedOn.ELEMENT || R || R !== a.elementHovered) &&
                ((A = l ? 1 - A : A),
                t.dispatch((0, _.parameterChanged)(S, A))),
              { elementHovered: R, clientX: v, clientY: I, pageX: y, pageY: m }
            );
          },
        }),
        (0, o.default)(r, W, {
        ...
        (0, o.default)(r, V, {
          ...
          handler: function (e) {
            ...
            var R = z(i, v),
              ...
              N = (g ? b : 0) / 100;
            (w = h ? w : 1 - w), (N = I ? N : 1 - N);
            var L = C.top + Math.min(C.height * w, f),
              D = C.top + C.height * N - L,
              P = Math.min(f + D, l),
              x = Math.min(Math.max(0, f - L), P) / P;
            return (
              x !== o.scrollPercent &&
                n.dispatch((0, _.parameterChanged)(R, x)),
              { scrollPercent: x }
            );
          },
        }),
    ...
    e.exports = function (e) {
      return i(function (t) {
        ...
        for (i = h ? i : n; ++i < n; ) {
          E = t[i];
          var _ = a(E),
            I = "wrapper" == _ ? o(E) : void 0;
          h =
            I && c(I[0]) && I[1] == (d | l | f | p) && !I[4].length && 1 == I[9]
              ? h[a(I[0])].apply(h, I[3])
              : 1 == E.length && c(E)
              ? h[_]()
              : h.thru(E);
        ...
        return function () {
          var e = arguments,
            r = e[0];
          if (h && 1 == e.length && u(r)) return h.plant(r).value();
    ...
    r.define(
      ...
      (e.exports = function (e, t) {
        ...
        function b(n, i) {
          var o = e(i),
            c = e.data(i, v);
          c || (c = e.data(i, v, { open: !1, el: o, config: {} })),
        ...
        (c.ready = c.design = c.preview = function () {
          if (
            ...
            return;
          o.each(b), m(), r.resize.on(O);
        }),
          (c.destroy = function () {
            (T = e()), m(), o && o.length && o.each(A);
          });
        var w = t.debounce(function (e, t) {
          if (e.open) {
        ...
        function x(e, t) {
          if (!e.open) {
            ...
            if (
              ...
              var p = c + o;
              s(e.menu).add(d).set({ y: -p }).start({ y: 0 });
            }
          }
        }
        function M(e) {
          ...
          return (
            t.animOver
              ? e.menu.height(r)
              : "fixed" !== e.el.css("position") && (r -= e.el.height()),
        ...
        function F(e, t) {
          if (e.open) {
            ...
            if (n.animOver)
              ...
              var u = a + i;
              s(e.menu).add(r).start({ y: -u }).then(c);
            }
          }
          function c() {
            e.menu.height(""),
              ...
              e.overlay &&
                ...
                (T.length ? e.menu.insertAfter(T) : e.menu.prependTo(e.parent),
...
Webflow.require("ix2").init({
  events: {
    ...
    "e-3": {
      ...
      createdOn: 1587671057975,
    },
  },
  actionLists: {
    "a-2": {
      id: "a-2",
      title: "Heading color changes",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5e97bf7a35e37a0e559e251e|bd3dccea-2189-bfa8-cead-3442f80ffaaa",
                },
                rValue: 255,
                gValue: 255,
                bValue: 255,
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5e97bf7a35e37a0e559e251e|1c85cd35-1abf-7ecc-d128-8744304b14a7",
                },
                rValue: 255,
                gValue: 255,
                bValue: 255,
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5e97bf7a35e37a0e559e251e|f3303365-7ac6-973d-6100-292a60e17700",
                },
                rValue: 255,
                gValue: 255,
                bValue: 255,
      ...
      createdOn: 1587664624861,
      useFirstGroupAsInitialState: true,
    },
    "a-4": {
      id: "a-4",
      title: "About me color change",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5ea1e49be88dc985e9683ba8|23bc22a0-a2f0-7faf-2e14-2070e289cc69",
                },
                rValue: 255,
                gValue: 255,
                bValue: 255,
